...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Doofuzz Demo Installer\n"
      else:
        line="OutputBaseFilename=Doofuzz Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Doofuzz Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Doofuzz installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Doofuzz Demo installer\n"
     else:
       line="SetupWindowTitle=Doofuzz installer\n"
